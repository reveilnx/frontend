...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__validators_mdp__ = __webpack_require__(268);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ts_md5_dist_md5__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_intl_tel_input__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_intl_tel_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_intl_tel_input__);
...
var RegisterPage = (function () {
    function RegisterPage(navCtrl, rest, formBuilder, navParams, menuCtrl) {
    ...
    RegisterPage.prototype.ionViewDidLoad = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_6_jquery__("#telephone2").intlTelInput({
            // allowDropdown: false,
    ...
    RegisterPage.prototype.formatVal = function () {
        ...
        var dialCode = __WEBPACK_IMPORTED_MODULE_6_jquery__("#telephone2").intlTelInput("getSelectedCountryData").dialCode;
    ...
    RegisterPage.prototype.registerUser = function () {
        ...
        var passwd = __WEBPACK_IMPORTED_MODULE_5_ts_md5_dist_md5__["Md5"].hashStr(this.registerForm.controls.mdp1.value);
        ...
        this.rest.post(url, body, true)
            ...
            if (value['success'] != undefined) {
                _this.rest.presentToast("Inscription réussie. Connectez vous pour accéder à la plateforme");
                _this.navCtrl.pop();
            }
            else {
                _this.rest.showAlert("Erreur : ", value['error']);
            }
        })
            .catch(function (err) {
            _this.rest.showAlert("Erreur Serveur : ", err);
    ...
    RegisterPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest__["a" /* RestProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest__["a" /* RestProvider */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormBuilder */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavParams */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* MenuController */]) === "function" && _e || Object])
    ], RegisterPage);
    return RegisterPage;
    var _a, _b, _c, _d, _e;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__providers_rest_rest__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(11);
...
var OperationsPage = (function () {
    ...
    /*/////////////////////////////////// CONSTRUCTEUR /////////////////////////////////////////////*/
    /*//////////////////////////////////////////////////////////////////////////////////////////////*/
    function OperationsPage(navCtrl, navparams, rest, formBuilder, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navparams = navparams;
        this.rest = rest;
        this.formBuilder = formBuilder;
    ...
    OperationsPage.prototype.validPay = function () {
        ...
        this.rest.post(url, body, true)
            .then(function (value) {
            _this.rest.presentToast("Opération effectuée avec succès");
        })
            .catch(function (err) {
            _this.rest.showAlert("Erreur Serveur : ", err);
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_common_http__ = __webpack_require__(162);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_login_login__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_register_register__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_wallet_wallet__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_compte_compte__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_operations_operations__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__providers_rest_rest__ = __webpack_require__(29);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__pages_compte_compte__["a" /* ComptePage */],
                __WEBPACK_IMPORTED_MODULE_12__pages_operations_operations__["a" /* OperationsPage */]
            ],
            imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__ = __webpack_require__(206);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_wallet_wallet__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_compte_compte__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_login_login__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__pages_operations_operations__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_rest_rest__ = __webpack_require__(29);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = (function () {
    function MyApp(platform, statusBar, splashScreen, rest) {
        ...
        this.initializeApp();
        this.pages = [
            { title: 'Wallet', component: __WEBPACK_IMPORTED_MODULE_4__pages_wallet_wallet__["a" /* WalletPage */], icon: 'basket' },
            { title: 'Opérations', component: __WEBPACK_IMPORTED_MODULE_7__pages_operations_operations__["a" /* OperationsPage */], icon: 'swap' },
            { title: 'Profil', component: __WEBPACK_IMPORTED_MODULE_5__pages_compte_compte__["a" /* ComptePage */], icon: 'contact' },
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/home/nico/Bureau/ionic/NXVision/src/app/app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n         <ion-icon class="sidebarIcon" name="{{p.icon}}"></ion-icon> {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"/home/nico/Bureau/ionic/NXVision/src/app/app.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */], __WEBPACK_IMPORTED_MODULE_8__providers_rest_rest__["a" /* RestProvider */]])
    ], MyApp);
    return MyApp;
}());
...
var RestProvider = (function () {
    ...
    RestProvider.prototype.post = function (url, body, load) {
        var _this = this;
        if (load) {
            this.loading = this.loadingCtrl.create({
                content: 'Chargement...',
        ...
        return new Promise(function (resolve, reject) {
            ...
            _this.http.post(url, body, { headers: heady })
                .subscribe(function (data) {
    ...
    /*////////////////////////////////////////////////////// SPECIFIC REQUESTS//////////// */
    /*//////////////////////////////////////////////////////////////////////////////////// */
    RestProvider.prototype.getSolde = function () {
        var _this = this;
        var tel = this.dataClient.telephone;
        this.get(this.urlServer + "/returnSolde.php" + "?telephone=" + tel, false)
            .then(function (value) {
            if (value["success"] == undefined)
                _this.presentToast("Utilisateur inconnu");
            else {
                _this.dataClient.solde = value["success"];
            }
        })
            .catch(function (err) {
            _this.showAlert("Erreur Serveur", err);
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__wallet_wallet__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__register_register__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_rest_rest__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ts_md5_dist_md5__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_intl_tel_input__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_intl_tel_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_intl_tel_input__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginPage = (function () {
    ...
    /* //////////////////////////////////////////// CONSTRUCTOR ///////////////////////////////////////////////////// */
    /* ////////////////////////////////////////////////////////////////////////////////////////////////////////////// */
    function LoginPage(navCtrl, navParams, rest, formBuilder, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.rest = rest;
        this.formBuilder = formBuilder;
        ...
        // check if user is already connected
        if (this.rest.dataClient != undefined)
            this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_3__wallet_wallet__["a" /* WalletPage */]);
        // LOGIN FORM BUILDER
    ...
    LoginPage.prototype.ionViewDidLoad = function () {
        this.menuCtrl.swipeEnable(false);
        __WEBPACK_IMPORTED_MODULE_7_jquery__("#telephone").intlTelInput({
            // allowDropdown: false,
            // autoHideDialCode: false,
            // autoPlaceholder: "aggressive",
            dropdownContainer: "body",
    ...
    LoginPage.prototype.loginUser = function () {
        ...
        if (!this.loginForm.valid) {
            ...
            var dialCode = __WEBPACK_IMPORTED_MODULE_7_jquery__("#telephone").intlTelInput("getSelectedCountryData").dialCode;
    ...
    LoginPage.prototype.checkExist = function (telephone, mdp) {
        var _this = this;
        var passwd = __WEBPACK_IMPORTED_MODULE_6_ts_md5_dist_md5__["Md5"].hashStr(mdp);
        this.rest.get(this.rest.urlServer + "/connexion.php" + "?telephone=" + telephone + "&mdp=" + passwd, true)
            ...
            if (value[0] == undefined)
                ...
                _this.rest.presentToast("Bienvenue " + value[0].prenom);
                _this.rest.dataClient = value[0];
                _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_3__wallet_wallet__["a" /* WalletPage */]);
            }
        })
            .catch(function (err) {
            _this.rest.showAlert("Erreur Serveur", err);
...
var ComptePage = (function () {
    ...
    /* //////////////////////////////////////////// CONSTRUCTOR ///////////////////////////////////////////////////// */
    /* ////////////////////////////////////////////////////////////////////////////////////////////////////////////// */
    function ComptePage(navCtrl, rest, formBuilder, navParams, menuCtrl) {
        this.navCtrl = navCtrl;
        this.rest = rest;
        this.formBuilder = formBuilder;
        this.navParams = navParams;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__login_login__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__compte_compte__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_in_app_browser__ = __webpack_require__(163);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var WalletPage = (function () {
    ...
    /*/////////////////////////////////// CONSTRUCTEUR /////////////////////////////////////////////*/
    /*//////////////////////////////////////////////////////////////////////////////////////////////*/
    function WalletPage(navCtrl, navparams, rest, formBuilder, inappbrowser, menuCtrl) {
        this.navCtrl = navCtrl;
        this.navparams = navparams;
        this.rest = rest;
        this.formBuilder = formBuilder;
    ...
    WalletPage.prototype.transferWallet = function (type) {
        ...
        this.rest.post(url, body, true)
            ...
            if (value['success'] != undefined) {
                if (type == "moneyIn")
                    _this.inappbrowser.create(_this.rest.webkitURL + "?moneyintoken=" + value['success']['MONEYINWEB']['TOKEN'] + "&p=https://www.lemonway.fr/mercanet_lw.css&lang=fr", "_system", _this.options);
                if (type == "moneyOut") {
